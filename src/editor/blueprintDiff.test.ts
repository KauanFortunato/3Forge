...
describe("compareComponentBlueprints", () => {
  ...
  it("summarizes changed object fields relevant to AI chat", () => {
    ...
    afterText.material.type = "physical";
    afterText.material.side = "double";
    afterText.material.mapImageId = "image-checker";
    afterText.material.roughness = 0.2;
    afterText.material.transmission = 0.4;
    ...
    expect(compareComponentBlueprints(before, after).changed).toEqual([
      {
        ...
        changes: [
          ...
          { path: "material.type", before: "standard", after: "physical" },
          { path: "material.side", before: "front", after: "double" },
          { path: "material.mapImageId", before: undefined, after: "image-checker" },
          { path: "material.roughness", before: 0.4, after: 0.2 },
          { path: "material.transmission", before: 0, after: 0.4 },
        ],
      },
    ]);
  });
