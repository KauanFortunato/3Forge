...
export function SettingsIcon(props: IconProps) {
  return (
    <Ico {...props}>
      ...
      <path d="M7 1.6 8 2l.32 1.42c.28.12.54.27.78.45l1.4-.43.8.8-.43 1.4c.18.24.33.5.45.78L12.74 6.7 13.1 7l-.36.3-1.42.28c-.12.28-.27.54-.45.78l.43 1.4-.8.8-1.4-.43c-.24.18-.5.33-.78.45L8 12l-1 .4-1-.4-.32-1.42a4.12 4.12 0 0 1-.78-.45l-1.4.43-.8-.8.43-1.4a4.12 4.12 0 0 1-.45-.78L1.26 7.3.9 7l.36-.3 1.42-.28c.12-.28.27-.54.45-.78l-.43-1.4.8-.8 1.4.43c.24-.18.5-.33.78-.45L6 2z" />
    </Ico>
  );
}
