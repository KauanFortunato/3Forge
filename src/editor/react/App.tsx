...
export function App() {
  ...
  const createAddMenuActions = useCallback((resolveTarget: () => InsertTarget): MenuAction[] => {
    ...
    return [
      ...
      { id: "add-cone", label: "Cone", icon: <MeshIcon {...iconSize} />, onSelect: createNodeAction("cone") },
      { id: "add-capsule", label: "Capsule", icon: <MeshIcon {...iconSize} />, onSelect: createNodeAction("capsule") },
      { id: "add-ring", label: "Ring", icon: <MeshIcon {...iconSize} />, onSelect: createNodeAction("ring") },
      { id: "add-torus", label: "Torus", icon: <MeshIcon {...iconSize} />, onSelect: createNodeAction("torus") },
      { id: "add-torus-knot", label: "Torus Knot", icon: <MeshIcon {...iconSize} />, onSelect: createNodeAction("torusKnot") },
      { id: "add-dodecahedron", label: "Dodecahedron", icon: <MeshIcon {...iconSize} />, onSelect: createNodeAction("dodecahedron") },
      { id: "add-icosahedron", label: "Icosahedron", icon: <MeshIcon {...iconSize} />, onSelect: createNodeAction("icosahedron") },
      { id: "add-octahedron", label: "Octahedron", icon: <MeshIcon {...iconSize} />, onSelect: createNodeAction("octahedron") },
      { id: "add-tetrahedron", label: "Tetrahedron", icon: <MeshIcon {...iconSize} />, onSelect: createNodeAction("tetrahedron") },
  ...
  }, [applyWorkspaceBlueprint, blueprintSnapshot, setTransientStatus, showToast, store, syncRecentProject]);
  ...
  const menus = useMemo(() => [
    {
      ...
      items: [
        ...
        { id: "file-import-hdr", label: "Import HDR Environment", icon: <ImagePropertyIcon width={14} height={14} />, onSelect: () => hdrInputRef.current?.click() },
