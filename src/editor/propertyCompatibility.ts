...
const GEOMETRY_PATHS: Record<Exclude<EditorNodeType, "group" | "model">, ReadonlyArray<string>> = {
  ...
  dodecahedron: ["geometry.radius", "geometry.detail"],
  icosahedron: ["geometry.radius", "geometry.detail"],
  octahedron: ["geometry.radius", "geometry.detail"],
  tetrahedron: ["geometry.radius", "geometry.detail"],
