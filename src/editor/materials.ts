...
const STANDARD_BASE_DEFINITIONS: NodePropertyDefinition[] = [
  ...
  { group: "Material", path: "material.roughnessMapImageId", label: "Roughness Map", type: "string", input: "select", options: [{ label: "None", value: "" }] },
  { group: "Material", path: "material.metalnessMapImageId", label: "Metalness Map", type: "string", input: "select", options: [{ label: "None", value: "" }] },
  { group: "Material", path: "material.normalMapImageId", label: "Normal Map", type: "string", input: "select", options: [{ label: "None", value: "" }] },
  { group: "Material", path: "material.aoMapImageId", label: "AO Map", type: "string", input: "select", options: [{ label: "None", value: "" }] },
  { group: "Material", path: "material.emissiveMapImageId", label: "Emissive Map", type: "string", input: "select", options: [{ label: "None", value: "" }] },
...
export function normalizeMaterialSpec(value: unknown, fallback: MaterialSpec): MaterialSpec {
  ...
  return {
    ...
    roughnessMapImageId: normalizeOptionalString(source.roughnessMapImageId, fallback.roughnessMapImageId),
    metalnessMapImageId: normalizeOptionalString(source.metalnessMapImageId, fallback.metalnessMapImageId),
    normalMapImageId: normalizeOptionalString(source.normalMapImageId, fallback.normalMapImageId),
    aoMapImageId: normalizeOptionalString(source.aoMapImageId, fallback.aoMapImageId),
    emissiveMapImageId: normalizeOptionalString(source.emissiveMapImageId, fallback.emissiveMapImageId),
