...
class TinyUSDZLoader extends Loader {
    ...
    async init( options = {}) {
        ...
        if (Object.prototype.hasOwnProperty.call(options, 'useZstdCompressedWasm') && options.useZstdCompressedWasm) {
            throw new Error('TinyUSDZLoader: zstd-compressed WASM is not supported in this build.');
        }
        ...
        if (!this.native_) {
            ...
            if (Object.prototype.hasOwnProperty.call(options, 'wasmBinary')) {
                wasmBinary = options.wasmBinary;
            }

            // Initialize with custom WASM binary if provided
    ...
    parse(binary /* ArrayBuffer */, filePath /* optional */, onLoad, onError) {
        ...
        // Enable native texture extraction for USDZ archives.
        // Without this, textures in larger USDZ files may silently fail to load.
        if (typeof usd.setLoadTextureInNative === "function") {
